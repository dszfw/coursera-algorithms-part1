...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(p.slopeTo(e));
        System.out.println(p.slopeTo(q));
        System.out.println(p.slopeTo(p));
        System.out.println("---------");
        System.out.println(c.slopeTo(p));
        System.out.println(e.slopeTo(p));
        ...
        q.draw();
        e.draw();
        new LineSegment(p, new Point(100, 100)).draw();
        StdDraw.show();
    }
}
